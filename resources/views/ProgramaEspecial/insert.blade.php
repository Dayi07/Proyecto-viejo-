    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0"> 
            ...
            <div class="content-body">
                <form action="{{ route('InsertEspecial') }}" method="POST">
                    @csrf
                    <div class="card">
                             ...
                             <div class="row">
                                 <div class="col-xl-4 col-md-6 col-12">
                                     <div class="mb-1">
                                         ...
                                         <input type="text" class="form-control" id="NombreProgEspecial" name="NombreProgEspecial" placeholder="Nombre" />
                                     </div>
                                 </div> 
                                 <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basicInput">Ingrese modalidad de formacion:</label>
                                        <input type="text" class="form-control" id="ModalidadProgEspecial" name="ModalidadProgEspecial" placeholder="Modalidad" />
                                    </div>
                                </div> 
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
