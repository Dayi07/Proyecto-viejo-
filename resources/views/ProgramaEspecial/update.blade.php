                             ...
                             <div class="row">
                                 <div class="col-xl-4 col-md-6 col-12">
                                     <div class="mb-1">
                                         ...
                                         <input type="text" class="form-control" value="{{ $esp->NombreProgEspecial }}" id="NombreProgEspecial" name="NombreProgEspecial" placeholder="Nombre" />
                                     </div>
                                 </div> 
                                 <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basicInput">Ingrese modalidad de formacion:</label>
                                        <input type="text" class="form-control" value="{{ $esp->ModalidadProgEspecial }}" id="ModalidadProgEspecial" name="ModalidadProgEspecial" placeholder="Modalidad" />
                                    </div>
                                </div> 
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
