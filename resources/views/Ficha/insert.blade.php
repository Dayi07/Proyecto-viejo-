...
@section('form')
   <form action="{{ route('InsertFicha') }}" method="POST">
        ...
        <input type="numbre" name="IdUnicoFicha" id="IdUnicoFicha"><br><br>

        <label for="">Fecha de inicio:</label>
        <input type="date" name="FechaInicio" id="FechaInicio"><br><br>

        <label for="">Fecha de terminacion:</label>
        <input type="date" name="FechaTerminacion" id="FechaTerminacion"><br><br>

        <label for="">Etapa de la ficha:</label>
        <input type="text" name="EtapaFicha" id="EtapaFicha"><br><br>
 
        <label for="">Nombre del responsable</label>
        <input type="text" name="NombreResponsable" id="NombreResponsable"><br><br>
