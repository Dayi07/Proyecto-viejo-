                     ...
                     <div class="row">
                         <div class="col-xl-4 col-md-6 col-12">
                             <div class="mb-1">
                                 ...
                                 <input type="text" class="form-control" id="NombreAprendiz" name="NombreAprendiz" placeholder="Nombre" />
                             </div>
                         </div>
                         <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" id="NumeroDocumento" name="NumeroDocumento" placeholder="Documento" />
                            </div>
                        </div>  
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                ...
                                <input type="email" class="form-control" id="CorreoAprendiz" name="CorreoAprendiz" placeholder="Correo" />
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese telefono de contacto:</label>
                                <input type="number" class="form-control" id="TelefonoAprendiz" name="TelefonoAprendiz" placeholder="Telefono" />
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese estado del aprendiz:</label>
                                <select class="form-select" aria-label="Default select example" name="EstadoAprendiz" id="EstadoAprendiz">
