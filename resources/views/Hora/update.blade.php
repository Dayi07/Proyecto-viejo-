                     ...
                     <div class="row">
                         <div class="col-xl-4 col-md-6 col-12">
                             <div class="mb-1">
                                 ...
                                 <input type="text" class="form-control" value="{{ $hor->HorasMonitores }}" id="HorasMonitores" name="HorasMonitores" placeholder="Horas" />
                             </div>
                         </div>
                         <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese horas de empresa:</label>
                                <input type="number" class="form-control" value="{{ $hor->HorasInstEmpresa }}" id="HorasInstEmpresa" name="HorasInstEmpresa" placeholder="Horas" />
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese horas de contratista externo:</label>
                                <input type="number" class="form-control" value="{{ $hor->HorasContratistaExterno }}" id="HorasContratistaExterno" name="HorasContratistaExterno" placeholder="Horas" />
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese horas planta:</label>
                                <input type="number" class="form-control" value="{{ $hor->HorasPlanta }}" id="HorasPlanta" name="HorasPlanta" placeholder="Horas" />
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese total de horas:</label>
                                <input type="number" class="form-control" value="{{ $hor->TotalHoras }}" id="TotalHoras" name="TotalHoras" placeholder="Total" />
                            </div>
                        </div>
                         <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
