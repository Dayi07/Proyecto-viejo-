                             ...
                             <div class="row">
                                 <div class="col-xl-4 col-md-6 col-12">
                                     <div class="mb-1">
                                         ...
                                         <input type="text" class="form-control" value="{{ $con->NombreConvenio }}" id="NombreConvenio" name="NombreConvenio" placeholder="Nombre" />
                                     </div>
                                 </div> 
                                 <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basicInput">Ingrese cobertura:</label>
                                        <input type="text" class="form-control" value="{{ $con->AmpliacionCovertura }}" id="AmpliacionCovertura" name="AmpliacionCovertura" placeholder="Covertura" />
                                    </div>
                                </div> 
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
