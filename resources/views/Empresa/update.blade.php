                             ...
                             <div class="row">
                                 <div class="col-xl-4 col-md-6 col-12">
                                     <div class="mb-1">
                                         ...
                                         <input type="text" class="form-control" value="{{$emp->NombreEmpresa}}" id="NombreEmpresa" name="NombreEmpresa" placeholder="Nombre" />
                                     </div>
                                 </div> 
                                 <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basicInput">Ingrese tipo de identificacion:</label>
                                        <input type="text" class="form-control" value="{{$emp->TipoIdentificacion}}" id="TipoIdentificacion" name="TipoIdentificacion" placeholder="Tipo Identificacion" />
                                    </div>
                                </div> 
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basicInput">Ingrese identificacion de la empresa:</label>
                                        <input type="number" class="form-control" value="{{$emp->IdEmpresa}}" id="IdEmpresa" name="IdEmpresa" placeholder="Identificacion" />
                                    </div>
                                </div>
                             </div>
