                     ...
                     <div class="row">
                         <div class="col-xl-4 col-md-6 col-12">
                             <div class="mb-1">
                                 ...
                                 <input type="text" class="form-control" value="{{ $ocu->NombreOcupacion }}" id="NombreOcupacion" name="NombreOcupacion" placeholder="Nombre" />
                             </div>
                         </div>
                         <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Ingrese codigo de horas:</label>
                                <input type="number" class="form-control" value="{{ $ocu->CodigoHora }}" id="CodigoHora" name="CodigoHora" placeholder="Codigo" />
                            </div>
                        </div>
                         <div class="col-xl-4 col-md-6 col-12">
                            <div class="mb-1">
